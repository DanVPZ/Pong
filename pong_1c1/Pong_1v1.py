...
def end_game(status):
    ...
    screen.blit(status, (screen_width / 2 - 290, screen_height / 2 - 55))
...
winner_text = big_font.render("Jugador 2 ha ganado :D", False, light_grey)
loser_text = big_font.render("Jugador 1 ha ganado :D", True, light_grey)
